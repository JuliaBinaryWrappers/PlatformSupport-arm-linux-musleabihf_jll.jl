module PlatformSupport-arm-linux-musleabihf_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PlatformSupport-arm-linux-musleabihf_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("4cf805d6-35d8-5348-baa7-ae09075f3768"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PlatformSupport-arm-linux-musleabihf", artifacts_toml) for e in artifacts["PlatformSupport-arm-linux-musleabihf"]]
...
if best_platform === nothing
    @debug("Unable to load PlatformSupport-arm-linux-musleabihf; unsupported platform $(triplet(platform_key_abi()))")
else
    # Load the appropriate wrapper
    include(joinpath(@__DIR__, "wrappers", "$(best_platform).jl"))
end

end  # module PlatformSupport-arm-linux-musleabihf_jll
